...
public class TestDeltaLakeSplitManager
{
    ...
    private DeltaLakeSplit makeSplit(long start, long splitSize, long fileSize, double minimumAssignedSplitWeight)
    {
        ...
        return new DeltaLakeSplit(FULL_PATH, start, splitSize, fileSize, Optional.empty(), 0, Optional.empty(), ImmutableList.of(), splitWeight, TupleDomain.all(), ImmutableMap.of());
    }
